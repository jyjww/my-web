import { a as __toCommonJS, i as __exportAll, n as __commonJSMin, r as __esmMin, t as require_react } from "./react-Di35R4jX.js";
...
var epsilon, pi, halfPi, quarterPi, tau, degrees$1, radians, abs, atan, atan2, cos, ceil, exp, hypot, log, pow, sin, sign, sqrt, tan;
...
function circle_default$1() {
	var center = constant_default$3([0, 0]), radius = constant_default$3(90), precision = constant_default$3(6), ring, rotate, stream = { point };
	function point(x, y) {
...
function projectionMutator(projectAt) {
	...
	projection.clipAngle = function(_) {
		return arguments.length ? (preclip = +_ ? circle_default(theta = _ * radians) : (theta = null, antimeridian_default), reset()) : theta * degrees$1;
	};
...
var init_color$1 = __esmMin((() => {
	...
	darker = .7;
	brighter = 1 / darker;
	reI = "\\s*([+-]?\\d+)\\s*", reN = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*", reP = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", reHex = /^#([0-9a-f]{3,8})$/, reRgbInteger = new RegExp("^rgb\\(" + [
		reI,
		reI,
		reI
...
var epsilon2, zoom_default$1;
var init_zoom$1 = __esmMin((() => {
	epsilon2 = 1e-12;
	zoom_default$1 = (function zoomRho(rho, rho2, rho4) {
		function zoom(p0, p1) {
...
var require_index_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		"object" == typeof exports && "undefined" != typeof module ? t(exports, require_react(), require_prop_types(), (init_src$10(), __toCommonJS(src_exports$3)), (init_src$9(), __toCommonJS(src_exports$2)), (init_src(), __toCommonJS(src_exports)), (init_src$7(), __toCommonJS(src_exports$1))) : "function" == typeof define && define.amd ? define([
			"exports",
			"react",
			"prop-types",
			"d3-geo",
